...
const FreqRanges = struct {
    pub const HSE_OSC = struct {
        pub const Min: Hz = 4_000_000;
        pub const Max: Hz = 16_000_000;
    };
    pub const HSE_BYP = struct {
        pub const Min: Hz = 1_000_000;
        pub const Max: Hz = 25_000_000;
    };
    pub const HCLK = struct {
        pub const Min: Hz = 0;
        pub const Max: Hz = 72_000_000;
    };
    pub const PCLK1 = struct {
        pub const Min: Hz = 0;
        pub const Max: Hz = 36_000_000;
    };
    pub const PCLK2 = struct {
        pub const Min: Hz = 0;
        pub const Max: Hz = 72_000_000;
    };
    pub const PLL_IN = struct {
        pub const Min: Hz = 1_000_000;
        pub const Max: Hz = 25_000_000;
    };
    pub const PLL_OUT = struct {
        pub const Min: Hz = 16_000_000;
        pub const Max: Hz = 72_000_000;
    };
    pub const ADC = struct {
        pub const Min: Hz = 0;
        pub const Max: Hz = 14_000_000;
    };
};
